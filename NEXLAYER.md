...
**Live:** [https://relaxed-weasel-coder.cloud.nexlayer.ai](https://relaxed-weasel-coder.cloud.nexlayer.ai)  
...
**coder** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  - name: app
    ...
    - 7080
    vars:
      CODER_PG_CONNECTION_URL: "postgresql://coder:coder@postgres.pod:5432/coder?sslmode=disable"
      CODER_ACCESS_URL: "https://relaxed-weasel-coder.cloud.nexlayer.ai"
